...
class FloodLossEstimates extends Component {
  render () {
   return (
        ...
        <div className='property-info-w'>
          <div className="property-info-main" style={{paddingTop: 0, paddingBottom: 0}}>
            ...
            <div className="property-section">
              <Content content_id={`risk-flood_loss_estimates`} />
            </div>
...
export default [
  {
    icon: 'icon-map',
    path: '/risk/floodlossestimates',
    name: 'floodlossestimates',
    exact: true,
    mainNav: false,
    menuSettings: {image: 'none', 'scheme': 'color-scheme-light'},
    subMenus: Submenus,
    component: connect(() => {}, {})(FloodLossEstimates),
  },
]
